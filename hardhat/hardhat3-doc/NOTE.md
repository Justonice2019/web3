...
* SEPOLIA_PRIVATE_KEY: 925eddbd83b71706148ba1799ce40eca3ea9d581e848ca87f01a0f46ae6b98df
* 当前项目我设置为 二级密码 (和当前电脑捆绑的)

## 获取 SEPOLIA_RPC_URL
https://developer.metamask.io/key/active-endpoints
![](./assets/note-1776820914857.png)

## 如何获取 SEPOLIA_PRIVATE_KEY

![](./assets/note-1776820950869.png)

![](./assets/note-1776820959842.png)

![](./assets/note-1776820968814.png)
...
# 注意事项
1. 如果重启 `npx hardhat node`, 已部署的合约信息会丢失, 所以 `./ignition/deployments\chain-31337/deployed_addresses.json`, 这里面的合约地址会失效的, 需要重新使用 ignition 重新部署
2. hardhat 的 fixture 功能同样适用于原生 ethers 使用 ContractFactory 部署的合约
